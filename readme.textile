h1. *{color:red}Editee, Code Editor Accessory for ExpressionEngine 2*
...
# Download Editee ExpressionEngine Accessory, unzip the package into "*{color:red}/system/expressionengine/third_party/*" folder.
# -Download EditArea "EditArea":http://sourceforge.net/projects/editarea/ and place the script on server.-
# Update the location variable e.g. *{color:red}$location = '/library/scripts/edit_area/'* based on where you placed EditArea script.
